...
//             <p>Consent</p>
//             <br />
//             <CheckBox label={"I accept the request to map the network."} onChange={checkedOptions1} checked={optionChecked1}/>
//             <CheckBox label={"I confirm that all devices are working and connected to the network."} onChange={checkedOptions2} checked={optionChecked2}/>
//           </div>
